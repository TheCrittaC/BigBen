__all__ = ["decide", "eat", "echo", "feet", "fortunes", "fourchan", "google", "htmlconvert", "imdb", "isup", "lastspoke", "nowplaying", "pagetitle", "ping", "question", "rt", "roll", "sed", "shorten", "stock", "tell", "tz", "tweet", "weather", "urban", "youtube", "help"]
__enabled__ = ["decide", "eat", "echo", "feet", "fortunes", "fourchan", "google", "htmlconvert", "imdb", "isup", "lastspoke", "nowplaying", "pagetitle", "ping", "question", "roll", "rt", "sed", "shorten", "stock", "tell", "tz", "tweet", "urban", "weather", "youtube", "help"]
__commands__ = {
    ".decide" : "decide",
    ".eat" : "eat",
    ".echo" : "echo",
...
__help__ = {
    ...
    "stock": ".stock SYMBOL - retrieve a stock quote for a given symbol",
